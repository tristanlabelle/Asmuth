...
namespace Asmuth.X86
{
	...
	public struct EffectiveAddress
	{
		...
		public static EffectiveAddress FromEncoding(
			...
			ModRM modRM, Sib sib, int displacement)
		{

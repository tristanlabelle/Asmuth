...
namespace Asmuth.X86.Asm
{
	...
	public readonly struct Register : IEquatable<Register>
	{
		...
		public static readonly Register AH = new Register(RegisterClass.GprByte, 0x14);
		public static readonly Register CH = new Register(RegisterClass.GprByte, 0x15);
		public static readonly Register DH = new Register(RegisterClass.GprByte, 0x16);
		public static readonly Register BH = new Register(RegisterClass.GprByte, 0x17);
	...
	public readonly struct RegisterClass : IEquatable<RegisterClass>
	{
		...
		public int? SizeInBytes => sizeInBytes == 0 ? (int?)null : sizeInBytes;
